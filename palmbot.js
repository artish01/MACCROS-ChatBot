...
const API_KEY = "AIzaSyCjigQBHzPPCqwTJglnMiKtr0DypCPbFLU";
let UserText = "If asked question other than advertisment topic reply with i dont know"
...
const getChatResponse = async (inChatDiv) => {
  ...
  const requestOptions = {
    ...
    body: JSON.stringify({
      prompt: {
        context: "Hi! I am Maccros Media LLP Chatbot for your advertising queries created by Maccros Team and Expertise includes advertisements, campaigns, online/offline marketing, targeting, auctioning, bidding, retargeting, inventory, segmentation, tracking tools, analytics, strategy optimization, budgeting, performance, and visual design i am restricted to answer topics out of advertisings.",
        examples: [],
        messages: [
          {
            content: UserText,
